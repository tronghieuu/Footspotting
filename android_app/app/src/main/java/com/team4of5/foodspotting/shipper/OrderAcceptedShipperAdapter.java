...
public class OrderAcceptedShipperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<Order> mOrders;
    private Context mContext;
    private Activity mActivity;
    private OnItemClickListener mListener;
    private BtnReceiveOrderShipperListener btnReceiveOrderShipperListener;
    private BtnCancelOrderShipperListener btnCancelOrderShipperListener;
    ...
    public interface BtnReceiveOrderShipperListener{
        void onReceiveShipButtonClick(View v, int position);
        void onContactButtonClick(View v, int position);
    }
    public interface BtnCancelOrderShipperListener{
        void onCancelShipButtonClick(View v, int position);
    }
    ...
    public OrderAcceptedShipperAdapter(Context context, List<Order> orders, RecyclerView recyclerView,
                                   OrderAcceptedShipperAdapter.BtnReceiveOrderShipperListener btnReceiveOrderShipperListener, OrderAcceptedShipperAdapter.BtnCancelOrderShipperListener btnCancelOrderShipperListener) {
        this.btnReceiveOrderShipperListener = btnReceiveOrderShipperListener;
        this.btnCancelOrderShipperListener = btnCancelOrderShipperListener;
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(mActivity).inflate(R.layout.item_order_accept_shipper, parent, false);
            return new OrderAcceptedShipperAdapter.ViewHolderRow(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(mActivity).inflate(R.layout.item_loading, parent, false);
            return new OrderAcceptedShipperAdapter.ViewHolderLoading(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof OrderAcceptedShipperAdapter.ViewHolderRow) {
            final Order order = mOrders.get(position);

            final OrderAcceptedShipperAdapter.ViewHolderRow userViewHolder = (OrderAcceptedShipperAdapter.ViewHolderRow) holder;
            ...
            FirebaseFirestore.getInstance().collection("restaurants")
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    if(documentSnapshot.exists()){
                        ...
                        new OrderAcceptedShipperAdapter.DownloadImageFromInternet(userViewHolder.imageViewRes)
            ...
            FirebaseFirestore.getInstance().collection("restaurants")
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    if(documentSnapshot.exists()){
                        ...
                        new OrderAcceptedShipperAdapter.DownloadImageFromInternet(userViewHolder.imageViewFood)
                                .execute(documentSnapshot.getString("image"));
                    }
                }
            });
            ...
            userViewHolder.btnReceived.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    btnReceiveOrderShipperListener.onReceiveShipButtonClick(view , position);
                }
            });
            ...
            userViewHolder.btnContact.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    btnReceiveOrderShipperListener.onContactButtonClick(view,position);
                }
            });
            userViewHolder.btnCancel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    btnCancelOrderShipperListener.onCancelShipButtonClick(view, position);
                }
            });
            // binding item click listner
            userViewHolder.bind(mOrders.get(position),mListener);
        } else if (holder instanceof OrderAcceptedShipperAdapter.ViewHolderLoading) {
            OrderAcceptedShipperAdapter.ViewHolderLoading loadingViewHolder = (OrderAcceptedShipperAdapter.ViewHolderLoading) holder;
    ...
    public class ViewHolderRow extends RecyclerView.ViewHolder {
        ...
        public Button btnReceived,btnCancel;
        ...
        public ViewHolderRow(View v) {
            ...
            btnReceived = v.findViewById(R.id.btnReceivedOrder);
            btnCancel = v.findViewById(R.id.btnCancelShip);
            btnContact = v.findViewById(R.id.btnContactRes);
        }

        public void bind(final Order item, final OrderAcceptedShipperAdapter.OnItemClickListener listener) {
