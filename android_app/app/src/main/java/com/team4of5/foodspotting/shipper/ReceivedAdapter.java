...
public class ReceivedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private ReceivedAdapter.BtnOrderReceivedShipperListener btnOrderReceivedShipperListener;

    // for load more
    private final int VIEW_TYPE_ITEM = 0;
    private final int VIEW_TYPE_LOADING = 1;
    private ReceivedAdapter.OnLoadMoreListener onLoadMoreListener;
    ...
    public interface BtnOrderReceivedShipperListener{
        void onReceivedButtonClick(View v, int position);
    ...
    public ReceivedAdapter(Context context, List<Order> orders, RecyclerView recyclerView,
                                   ReceivedAdapter.BtnOrderReceivedShipperListener btnOrderReceivedShipperListener) {
        this.btnOrderReceivedShipperListener = btnOrderReceivedShipperListener;
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(mActivity).inflate(R.layout.item_order_received_shipper, parent, false);
            return new ReceivedAdapter.ViewHolderRow(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(mActivity).inflate(R.layout.item_loading, parent, false);
            return new ReceivedAdapter.ViewHolderLoading(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ReceivedAdapter.ViewHolderRow) {
            final Order order = mOrders.get(position);

            final ReceivedAdapter.ViewHolderRow userViewHolder = (ReceivedAdapter.ViewHolderRow) holder;
            ...
            FirebaseFirestore.getInstance().collection("restaurants")
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    if(documentSnapshot.exists()){
                        ...
                        new ReceivedAdapter.DownloadImageFromInternet(userViewHolder.imageViewRes)
            ...
            FirebaseFirestore.getInstance().collection("restaurants")
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    if(documentSnapshot.exists()){
                        ...
                        new ReceivedAdapter.DownloadImageFromInternet(userViewHolder.imageViewFood)
                                .execute(documentSnapshot.getString("image"));
                    }
                }
            });
            ...
            userViewHolder.btnPickShip.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    btnOrderReceivedShipperListener.onReceivedButtonClick(view , position);
                }
            });
            ...
            userViewHolder.btnContact.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    btnOrderReceivedShipperListener.onContactButtonClick(view , position);
                }
            });

            // binding item click listner
            userViewHolder.bind(mOrders.get(position), mListener);
        } else if (holder instanceof ReceivedAdapter.ViewHolderLoading) {
            ReceivedAdapter.ViewHolderLoading loadingViewHolder = (ReceivedAdapter.ViewHolderLoading) holder;
    ...
    public void setOnLoadMoreListener(ReceivedAdapter.OnLoadMoreListener mOnLoadMoreListener) {
        this.onLoadMoreListener = mOnLoadMoreListener;
    }

    public void setOnItemListener(ReceivedAdapter.OnItemClickListener listener) {
    ...
    public class ViewHolderRow extends RecyclerView.ViewHolder {
        ...
        public Button btnPickShip, btnContact;
        ...
        public ViewHolderRow(View v) {
            ...
            btnPickShip = v.findViewById(R.id.btnPassShip);
            btnContact = v.findViewById(R.id.btnContactCustomer);
        }

        public void bind(final Order item, final ReceivedAdapter.OnItemClickListener listener) {
